...
const THAI_HOLIDAYS_2026: Record<string, string> = {
  ...
  '2026-07-28': 'วันเฉลิมพระชนมพรรษา พระบาทสมเด็จพระวชิรเกล้าเจ้าอยู่หัว',
  ...
  '2026-12-07': 'วันชดเชยวันคล้ายวันพระบรมราชสมภพ ร.9',
...
// วันหยุดราชการไทย 2027 (พ.ศ. 2570) — อ้างอิงประกาศธนาคารแห่งประเทศไทย
const THAI_HOLIDAYS_2027: Record<string, string> = {
  '2027-01-01': 'วันขึ้นปีใหม่',
  '2027-02-22': 'ชดเชยวันมาฆบูชา (วันอาทิตย์ที่ 21 กุมภาพันธ์ 2570)',
  ...
  '2027-05-03': 'ชดเชยวันแรงงานแห่งชาติ (วันเสาร์ที่ 1 พฤษภาคม 2570)',
  '2027-05-04': 'วันฉัตรมงคล',
  '2027-05-20': 'วันวิสาขบูชา',
  '2027-06-03': 'วันเฉลิมพระชนมพรรษา สมเด็จพระนางเจ้าสุทิดา พัชรสุธาพิมลลักษณ พระบรมราชินี',
  '2027-07-19': 'ชดเชยวันอาสาฬหบูชา (วันอาทิตย์ที่ 18 กรกฎาคม 2570)',
  '2027-07-28': 'วันเฉลิมพระชนมพรรษาพระบาทสมเด็จพระเจ้าอยู่หัว',
  '2027-08-12': 'วันเฉลิมพระชนมพรรษาสมเด็จพระนางเจ้าสิริกิติ์ พระบรมราชินีนาถ พระบรมราชชนนีพันปีหลวง และวันแม่แห่งชาติ',
  '2027-10-13': 'วันนวมินทรมหาราช',
  '2027-10-25': 'ชดเชยวันปิยมหาราช (วันเสาร์ที่ 23 ตุลาคม 2570)',
  '2027-12-06': 'ชดเชยวันคล้ายวันพระบรมราชสมภพพระบาทสมเด็จพระบรมชนกาธิเบศร มหาภูมิพลอดุลยเดชมหาราช บรมนาถบพิตร วันชาติ และวันพ่อแห่งชาติ (วันอาทิตย์ที่ 5 ธันวาคม 2570)',
  '2027-12-10': 'วันรัฐธรรมนูญ',
  '2027-12-31': 'วันสิ้นปี',
};

const BUILTIN_HOLIDAYS: Record<string, string> = { ...THAI_HOLIDAYS_2025, ...THAI_HOLIDAYS_2026, ...THAI_HOLIDAYS_2027 };
