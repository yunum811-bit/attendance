...
ส่ง API Key ผ่าน header หรือ query parameter:

```
Header:  X-API-Key: sf-attendance-api-2026
Query:   ?api_key=sf-attendance-api-2026
```

**Response 401 (ถ้า key ไม่ถูกต้อง):**
```json
...
**ตัวอย่าง:**
```
GET /api/external/attendance?department_id=2&start_date=2026-05-01&end_date=2026-05-31&api_key=sf-attendance-api-2026
```
...
**ตัวอย่าง:**
```
GET /api/external/leave?department_id=2&status=approved&start_date=2026-01-01&end_date=2026-12-31&api_key=sf-attendance-api-2026
```
...
```javascript
const API_KEY = 'sf-attendance-api-2026';
